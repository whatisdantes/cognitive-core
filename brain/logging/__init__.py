...
Реализовано (C.1–C.3):
    ...
    TraceBuilder     — цепочка причинности по trace_id
                       (reasoning_tracer.py, renamed to avoid
                       conflict with brain/output/trace_builder.py)
...
from brain.logging.brain_logger import _NULL_LOGGER, BrainLogger, NullBrainLogger
from brain.logging.digest_generator import CycleInfo, DigestGenerator
from brain.logging.reasoning_tracer import _NULL_TRACE_BUILDER, NullTraceBuilder, TraceBuilder
