...
>
> Актуальный roadmap: [`TODO.md`](https://github.com/whatisdantes/cognitive-core/blob/main/docs/planning/TODO.md)
...
> Актуальный roadmap с точными статусами: [`TODO.md`](https://github.com/whatisdantes/cognitive-core/blob/main/docs/planning/TODO.md).
